    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateExerciseModalLabel{{ $exercise->exercise_workout_connect_id }}">{{ __('Update Exercise') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <form action="{{ route('deleteWorkoutDayExercise', $exercise->exercise_workout_connect_id) }}" method="POST" onsubmit="return confirm('{{ __('Are you sure you want to delete this exercise? This action cannot be undone.') }}');">
                        @csrf
                        @method('DELETE')
