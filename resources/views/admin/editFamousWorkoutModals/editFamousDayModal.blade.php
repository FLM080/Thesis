    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="workout_day_id" value="{{ $day->workout_day_id }}">
                    <div class="row">
                        ...
                        @enderror
                        <div class="col-md-6 mb-3">
                            <label for="workout_day" class="form-label">{{ __('Day') }}</label>
            ...
            <div class="modal-footer">
                <form action="{{ route('deleteFamousWorkoutDay', $day->workout_day_id) }}" method="POST" onsubmit="return confirm('{{ __('Are you sure you want to delete this day? This action cannot be undone.') }}');">
                    @csrf
                    @method('DELETE')
